 ...
 * 마지막 수정자: 백승훈
 * 마지막 수정 시간:2026-05-21/0937i
 * 수정 내용: 여러 집안일의 특정 기간 완료 기록을 조회하는 메서드 추가
...
public interface ChoreRecordRepository extends JpaRepository<ChoreRecord, Long> {
	...
	// 여러 집안일의 특정 기간 완료 기록을 한 번에 조회 
    List<ChoreRecord> findByChoreIdInAndCompletedAtBetween(List<Long> choreIds, LocalDateTime start, LocalDateTime end);
